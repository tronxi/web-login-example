...
insert into section_entity (id, description, name, question_id)
    values (1, "preguntas con respuestas de verdadero o falso con flujos distintos seguún la elección", "preguntas verdader o falso", 2);
...
INSERT INTO `weblogin`.`question_entity` (dtype,id,description,image_url,is_mandatory,question_type,title,next_if_false_id,next_if_true_id,next_question_id, allow_multiple, default_question_id)
